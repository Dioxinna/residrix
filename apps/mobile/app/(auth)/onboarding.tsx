  ...
  return (
    <View className="flex-1">
      ...
      <ScrollView contentContainerClassName="flex-grow justify-center px-6 py-10">
        ...
        <Text className="text-ink text-2xl font-bold mb-2">Únete a tu comunidad</Text>
        ...
        <View className="mb-4">
          <Text className="text-ink-soft text-sm font-medium mb-2">Nombre completo</Text>
          <TextInput
            value={fullName}
        ...
        <View className="mb-6">
          <Text className="text-ink-soft text-sm font-medium mb-2">Código de invitación</Text>
          <TextInput
            value={code}
            ...
            autoCorrect={false}
            maxLength={8}
            className="bg-surface border border-glassline rounded-xl px-4 py-4 text-ink text-lg font-mono tracking-widest text-center"
          />
        </View>
