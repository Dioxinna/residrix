...
const selectClass = 'bg-[color:var(--c-surface)] border border-[color:var(--glass-border)] text-ink-soft text-sm rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-violet-500'
  ...
  return (
    <div className="flex flex-wrap gap-3">
      <input
        ...
        className="bg-[color:var(--c-surface)] border border-[color:var(--glass-border)] text-ink-soft text-sm rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-violet-500 w-56 placeholder:text-ink-faint"
      />
